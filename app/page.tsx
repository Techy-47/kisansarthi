    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 p-4">
      <Card className="w-full max-w-2xl">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-3xl font-bold text-balance">Welcome to KisanSaathi</CardTitle>
          <CardDescription className="text-base">Your AI-powered farming companion</CardDescription>
        </CardHeader>
        <CardContent>
